...
function theme-apply-{{scheme-slug}} -d "{{scheme-name}} theme"
    ...
    if test -z $theme_apply_fish_shell_disable_prompt_colors
        ...
        set -gx fish_color_redirection "{{base0A-hex}}" yellow
        set -gx fish_color_end "{{base0C-hex}}" cyan
        set -gx fish_color_error "{{base08-hex}}" red
        set -gx fish_color_param "{{base06-hex}}" cyan
        set -gx fish_color_comment "{{base03-hex}}" brblack
        set -gx fish_color_match --background=brblue
        set -gx fish_color_selection "{{base05-hex}}" white --bold --background=brblack
        set -gx fish_color_search_match "{{base0A-hex}}" bryellow --background=brblack
        set -gx fish_color_history_current --bold
        set -gx fish_color_operator "{{base0C-hex}}" cyan
        set -gx fish_color_escape "{{base0C-hex}}" cyan
        set -gx fish_color_cwd "{{base0B-hex}}" green
        set -gx fish_color_cwd_root "{{base08-hex}}" red
        set -gx fish_color_valid_path --underline
        set -gx fish_color_autosuggestion "{{base03-hex}}" brblack
        set -gx fish_color_user "{{base0B-hex}}" brgreen
        set -gx fish_color_host normal
        set -gx fish_color_cancel -r
        set -gx fish_pager_color_completion normal
        set -gx fish_pager_color_description "{{base0A-hex}}" yellow
        set -gx fish_pager_color_prefix "{{base05-hex}}" white --bold --underline
